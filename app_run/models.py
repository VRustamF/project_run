...
class Subscribe(models.Model):
    athlete = models.ForeignKey(to=User, on_delete=models.CASCADE, related_name='athlete')
    coach = models.ForeignKey(to=User, on_delete=models.CASCADE, related_name='coach')
